...
<section class="py-4">
  <div class="container mx-auto px-4">
    <div class="pb-6 lg:pb-1 border-b border-gray-100 dark:border-gray-600">
      <div class="flex flex-wrap items-start justify-between">
        <div class="w-full lg:w-1/5 mb-1 lg:mb-0">
          <a class="inline-block mb-1 text-gray-900 text-lg font-semibold" href="#">
            <img class="h-16" src="/images/logo/intstu_logo.png" alt="" width="auto">
        ...
        <div class="w-full lg:w-auto">
          <ul class="flex flex-wrap space-x-4 lg:space-x-8 items-center text-sm">
            ...
            <li class="mb-2 md:mb-0"><a class="text-sm font-medium" href="#">Services</a></li>
            <li class="mb-2 md:mb-0"><a class="text-sm font-medium" href="#">Testimonials</a></li>
          </ul>
        </div>
      </div>
    </div>
    <div>
      <div class="flex flex-wrap justify-between items-center">
        <p class="text-sm text-gray-500 mt-1">All rights reserved &copy; Intstu 2024</p>
        <div class="flex order-first sm:order-last mt-8">
          ...
          <a class="flex justify-center items-center w-10 h-10 bg-gray-50 rounded-full" href="#">
