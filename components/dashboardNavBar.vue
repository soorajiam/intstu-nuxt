      ...
      <div class="flex justify-between items-center">
          ...
          <ul class="hidden flex-col justify-center mt-0 w-full text-sm font-medium text-gray-500 md:flex-row dark:text-gray-400 md:flex">
              <li class="block border-b dark:border-gray-700 md:inline md:border-b-0">
                  <a href="#" class="block py-3 px-4 rounded-lg hover:text-gray-900 dark:hover:text-white">Website</a>
              </li>
              <li class="block border-b dark:border-gray-700 md:inline md:border-b-0">
                  <a href="#" class="block py-3 px-4 rounded-lg hover:text-gray-900 dark:hover:text-white">Blogs</a>
              </li>
              <li class="block border-b dark:border-gray-700 md:inline md:border-b-0">
              ...
              <li class="block border-b dark:border-gray-700 md:inline md:border-b-0">
                  <a href="#" class="block py-3 px-4 rounded-lg hover:text-gray-900 dark:hover:text-white">Institutes</a>
              </li>
              <li class="block border-b dark:border-gray-700 md:inline md:border-b-0">
                <button @click="changeTheme()" data-tooltip-target="tooltip-dark" type="button"
              class=" mt-2 inline-flex items-center mr-1 text-sm font-medium text-gray-500 rounded-lg dark:text-gray-400 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
          ...
          <div class="flex flex-shrink-0 justify-between items-center ml-4 lg:order-2">
              <div class="relative">
                <button type="button" class="hidden justify-center items-center py-2 px-4 mr-2 text-sm font-medium text-white bg-indigo-700 rounded-lg sm:inline-flex hover:bg-indigo-800 focus:ring-4 focus:ring-primary-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-primary-800"><svg class="mr-1 -ml-1 w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg> Upgrade</button>
              <!-- Notifications -->
              <button @click="showNotifications=!showNotifications; showToolsMenu=showUserMenu=false" type="button" data-dropdown-toggle="notification-dropdown" class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
              ...
              <!-- Dropdown menu -->
              <div v-if="showNotifications" class="absolute right-0 w-80 z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                  ...
                  <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                      ...
                      <img class="w-11 h-11 rounded-full" src="https://Intstu.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Green avatar">
                      <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-indigo-700 dark:border-gray-700">
                  ...
                  <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                      <div class="flex-shrink-0">
                      <img class="w-11 h-11 rounded-full" src="https://Intstu.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Jese Leos avatar">
                  ...
                  <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                      <div class="flex-shrink-0">
                      <img class="w-11 h-11 rounded-full" src="https://Intstu.s3.amazonaws.com/blocks/marketing-ui/avatars/joseph-mcfall.png" alt="Joseph McFall avatar">
                  ...
                  <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                      <div class="flex-shrink-0">
                      <img class="w-11 h-11 rounded-full" src="https://Intstu.s3.amazonaws.com/blocks/marketing-ui/avatars/roberta-casas.png" alt="Roberta Casas image">
                  ...
                  <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600">
                      <div class="flex-shrink-0">
                      <img class="w-11 h-11 rounded-full" src="https://Intstu.s3.amazonaws.com/blocks/marketing-ui/avatars/robert-brown.png" alt="Robert image">
              ...
              <!-- Apps -->
             <div class="relative">
              <button @click="showToolsMenu=!showToolsMenu; showNotifications=showUserMenu=false" type="button" data-dropdown-toggle="apps-dropdown" class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                  <span class="sr-only">View notifications</span>
                  <!-- Icon -->
              ...
              <!-- Dropdown menu -->
              <div v-if="showToolsMenu" class="absolute right-0 w-96  z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
                  <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      Apps
                  </div>
              ...
              <div class="relative">
                <button @click="showUserMenu=!showUserMenu; showNotifications=showToolsMenu=false" type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                  <span class="sr-only">Open user menu</span>
                  <img class="w-8 h-8 rounded-full" src="https://Intstu.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
              </button>
              <!-- Dropdown menu -->
              <div v-if="showUserMenu" class="absolute right-0 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                  <div class="py-3 px-4">
                      <span class="block text-sm font-semibold text-gray-900 dark:text-white">Neil sims</span>
                      <span class="block text-sm text-gray-500 truncate dark:text-gray-400">name@Intstu.com</span>
                  </div>
          ...
          <div class="flex flex-col justify-between items-center md:flex-row">
              <ul class="flex flex-col order-2 mt-0 w-full text-sm font-medium bg-gray-50 rounded-lg border border-gray-200 md:flex-row md:order-1 md:bg-white dark:bg-gray-800 dark:border-gray-700 dark:md:bg-gray-900 md:rounded-none md:border-0">
                  <li v-for="feature in publishedFeatures" :key="feature.title">
                      ...
                      :to="feature.link" class="flex block py-3 px-4 rounded-lg hover:text-primary-400  hover:bg-gray-20 dark:hover:text-primary-400 dark:hover:bg-gray-800 dark:hover-bg-gray-80 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700" aria-current="page">
                        <span class="flex items-center">
                          <component :is="feature.icon"  class="w-5 h-5 mr-2"  aria-hidden="true" />
                          </span>
              ...
              <form class="flex order-1 items-center mb-4 w-full md:ml-4 md:max-w-sm md:order-2 md:mb-0">   
                  ...
                  <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-indigo-700 rounded-lg border border-primary-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-primary-800">
...
// return the current path as computerd property
...
const featuresAvailable = [
  ...
  {
    title: "List",
    description: "Create a list of your favorite items.",
    icon: QueueListIcon,
    color: "bg-yellow-500",
    published : true,
    link: "/dashboard/list/"
  ...
  {
    title: "Suggest Features/ Feedbacks",
    description: "Join the discussion.",
    icon: HandRaisedIcon,
    color: "bg-yellow-500",
    published : false,
